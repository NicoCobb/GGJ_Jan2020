...
public class CircleMoveable2D : CircleRaycastController
{
    ...
    public void Move(Vector2 moveAmount, bool standingOnPlatform)
    {
        ...
        moveAmount.x = Mathf.SmoothDamp(collisions.moveAmountOld.x, moveAmount.x, ref velocityXSmoothing, accelerationTimeGrounded);
    ...
    void HorizontalCollisions(ref Vector2 moveAmount)
    {
        ...
        for (int i = 0; i < horizontalRayCount; i++)
        {
            ...
            RaycastHit2D push = Physics2D.Raycast(rayOrigin, Vector2.right, rayLength, collisionMask);
            ...
            if (hit)
            {
                ...
                if (i == 0 && slopeAngle <= maxSlopeAngle)
                {
                    ...
                    if (slopeAngle != collisions.slopeAngleOld)
                    {
                        ...
                        moveAmount.x -= distanceToSlopeStart * -1;
                    }
            ...
            if (push)
                push.transform.GetComponent<Player>().SetVelocity(new Vector2(100, 0));
        }
